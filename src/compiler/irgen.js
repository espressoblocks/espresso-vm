...
class ScriptTreeGenerator {
    ...
    descendInput (block) {
        ...
        /*
        case 'sensing_getdata':
            return {
                kind: 'sensing.getdata',
                left: this.descendInputOfBlock(block,'DATA_KEY')
            }
        case 'sensing_uploaddata':
            return {
                kind: 'sensing_uploaddata'
            }
        */
        case 'sensing_unixtimestamp':
            return {
                kind: 'sensing.unixtimestamp'
            }
        case 'sensing_getdatalocal':
            //ignore this its for debugging :BLEH:
            console.log(`
                           ...
                           @@@@@@@@@@@@@#***+=--:::::::-=+***#%@@@@@@@@@@@@                         
                              @@@@@@@@@@@%#**+++++*#####****#@@@@@@@@@@                             
                                    @@@@@@@@@@@@@@%%%#####%@@@@@@                                   
                                             @@@@@%%%@%@@@                                          
                                                 @@%@@                                              
            `,block,this.descendInputOfBlock(block,'DATA_KEY'))
            return {
                kind: 'sensing.getdatalocal',
                left: this.descendInputOfBlock(block,'DATA_KEY')
            }
        ...
        case 'sensing_dayssince2000':
            ...
            case 'strings_reverse':
                return {
                    kind: 'strings.reverse',
                    left: this.descendInputOfBlock(block, 'TEXT')
                }
